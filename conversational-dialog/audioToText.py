...
if __name__ == "__main__":
    ...
    try:
        ...
        # Save transcription to a text         
        text_filename = '/Users/patelrudra/Downloads/interview-pilot-ai-main/conversational-dialog/audio-extraction/temp.txt'  # Save as .txt, not .mp3
